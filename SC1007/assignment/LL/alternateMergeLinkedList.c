...
{
	// add your code here
	int maxindex=(ll1->size)*2-1;
    //this is the index of the very last element you can possibly insert into linkedlist1, for example if LL1 has 3 elements,
    //the max you can put is 3 elements also, and the very last one will be at the 5th position, and 5=3X2-1

	int index=0;
	while(ll2->head && index<=maxindex)
	{
		if(index%2!=0)
		{
