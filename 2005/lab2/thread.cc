...
Thread::Finish ()
{
	...
	/* Add code here to reset the timer interrupt so that the next 
        ...
        */
	interrupt->InterruptRemove();	// remove the pending interrupt at the front of pending list
	// ASSUMPTION: all pending interrupts from the pending list are from the timer interrupts
